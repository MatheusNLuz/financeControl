        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                <div className="relative space-y-0.5 text-red-600 dark:text-red-100">
                    <p className="font-medium">Perigo!</p>
                    <p className="text-sm">Por favor prossiga com cautela, esse passo não pode ser desfeito.</p>
                </div>
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        <DialogTitle>Você tem certeza que quer deletar sua conta?</DialogTitle>
                        <DialogDescription>
